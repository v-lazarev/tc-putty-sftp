...
- support for SCP only servers (no SFTP)
- keep alive
- transfer files >2GB via SCP
- new: option to show user, group and permissions as custom columns
- new: set preferred crypto methods
...
20250826 Release, version 3.10 beta 10
20250826 Added: Increased maximum supported password length to 259 characters
...
20250529 Fixed: Reduce overhead by debug logging
20250526 Release, version 3.10 beta 8
20250526 Added: Support SCP transfers of files with spaces from/to Hetzner storage box. This is seriously broken, all uploads fail after a single download, need to reconnect
20250525 Added: Support debug logging from libssh2.dll. By default, only errors are logged (value 128). Add debuglog=<value> to sftpplug.ini, sum of LIBSSH2_TRACE_ values from https://github.com/libssh2/libssh2/blob/master/include/libssh2.h
20250423 Release, version 3.10 beta 7
20250423 Fixed: Curve ssh-ed25519 was no longer the default method for host key, resulting in changed key warnings
20250422 Release, version 3.10 beta 6
20250422 Added: Set preferred crypto method via sftpplug.ini manually in server-specific section
20250421 Added: Updated to LibSSH2 11.1 with support for chacha20-poly1305@openssh.com, aes256-gcm@openssh.com and  aes128-gcm@openssh.com
20240229 Release, version 3.10 beta 5
20240229 Fixed: The first file or folder (alphabetically) starting with an exclamation mark "!" wasn't shown on OpenWRT servers
20240202 Release, version 3.10 beta 4
20240130 Added: Updated libssh2 to version 1.11 (with ECDH and ed25519 extensions)
20240121 Added: Use dynamic buffer size for uploads and downloads, created by forum user "CoolWater"
20231128 Release, version 3.10 beta 3
20231128 Added: Detect when remote server is missing scp command, so the libssh2 dll doesn't crash. scp error shows up in log
20231126 Added: Remote copying files with F5 between two folders on the server: Use parameter -p to keep the file timestamp (retry without in case of error, turn off if error recognized) 
20230901 Release, version 3.10 beta 2
20230901 Fixed: The "permissions" custom column showed "-???" instead of -000 for files with all permissions denied
20230901 Fixed: The "permissions" custom column showed "L" for all files, not just for links
20230817 Release, version 3.10 beta 1
20230809 Added: Option to show user, group and permissions as custom columns, developed by forum user CoolWater
20230324 Release, version 3.05 final
20230324 Fixed: Support any language in reply to stat command as long as the response contains "Uid:"
20230321 Added: Support German reply to stat command
20230321 Fixed: Support tabstops \t in addition to spaces in reply to stat command
20221031 Release, version 3.04 final
20221031 Added: Support new key exchange methods curve25519-sha256 and curve25519-sha256@libssh.org
20221017 Release, version 3.03 final
20221017 Fixed: 64-bit: Crash when trying to connect with host key encrypted with old method, key starts with -----BEGIN RSA PRIVATE KEY-----
20220826 Release, version 3.02 final
20220825 Fixed: Crash when trying to connect with host key using rsa-sha2-512 in some cases
20220824 Release, version 3.01 final
20220824 Fixed: Crash when trying to connect with host key using curve ed25519
20220823 Release, version 3.00 final
20220612 Added: Show used encryption methods in the Total Commander FTP log
20220610 Release, version 3.00 beta 1
20220610 Added: Support alternative RSA host key methods (for client certificate): rsa-sha2-512,rsa-sha2-256, use instead of ssh-rsa if the server supports it
20220610 Added: Support new key exchange methods diffie_helman_group14_sha256, diffie_helman_group16_sha512 and diffie_helman_group16_sha512
20211109 Release, version 2.90 final
20211109 Added: Keep old target file (which would be overwritten) when download fails at the start
20210630 Release, version 2.80 final
20210630 Added: Prefer curve ed25519 also in XP version. Note: You may get a warning about a changed server key because the new method is used!
20210630 Added: scramble server passwords in memory
20210622 Release, version 2.80 beta 5
20210622 Fixed: When both curve ed25519 and the nist curves are supported by the server, prefer curve ed25519
20200724 Release, version 2.80 beta 4
20200724 Fixed: On uploads via SCP, the permissions (chmod) was always set in 32-bit (also when overwriting), but never set in 64-bit (SCP only servers)
20200714 Release, version 2.80 beta 3
20200714 Fixed: Minor bugfixes, main fix in version for XP
20200709 Release, version 2.80 beta 2
20200709 Handle dual login via client certificate and keyboard interactive, where the server only requests a second factor, no password
20200708 Release, version 2.80 beta 1
20200708 Added: Support servers which require dual login via client certificate AND keyboard interactive or password, e.g. for 2 factor authentication
